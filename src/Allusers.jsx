...
export default function Alldeps() {
    ...
    const [depiduser,setdepid] = useState()
  ...
  return (
    ...
    <form onSubmit={updatedep} className={`modalchangedata d-${none}`}>
        ...
        <div className="thismodal">
            ...
            <div className="name">
                <input ref={emailchangedep} value={email} type="text" />
                <input ref={phonechangedep} value={phone} type="text" />
            </div>
            ...
            <div className="name">
                <input ref={namechangedep} value={name} type="text" />
                <input ref={depid} value={depiduser} type="text" />
            </div>
